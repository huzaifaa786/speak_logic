...
class _SoftwareScreenState extends State<SoftwareScreen> {
  ...
  fetchsoftware() async {
    await softwareController.getsoftware();
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SoftwareController>(
              ...
              Container(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final item = controller.softwares[index];
                    return Stack(
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                                SvgPicture.network(
                                          Image_URL +
                                              controller.softwares[index].image!,
                                          height: 160,
                                          fit: BoxFit.cover,
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 4.0, bottom: 2),
                                child: Text(
                                  controller.softwares[index].name!,
                                  maxLines: 1,
